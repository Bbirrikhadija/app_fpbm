...
public class StriAdapter extends ArrayAdapter<String> {
...
public StriAdapter(Context context, ArrayList<String> records){
...
public void onClick(View v){
        ...
        database= FirebaseDatabase.getInstance().getReference().child("emploi").child("stri").child(item);
